...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    /**
     * Checando se o prestator não esta criando um agendamento para ele mesmo
     */
    const user = await User.findByPk(req.userId);

    if (user.id === provider_id) {
      return res.status(401).json({ error: 'Deu certo' });
    }
  ...
  async delete(req, res) {
    ...
    // Verificando se o solicitando realmente o dono do agendamento
    ...
    // Verificando se a data e hora atual está 2 horas abaixo
